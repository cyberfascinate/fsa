...
import { MapPin, Phone, Mail, Clock, Send, CheckCircle, AlertCircle, Calendar, Linkedin } from 'lucide-react';
...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Phone",
      details: ["+91 95604 19070"]
    },
    {
      icon: <Mail className="h-6 w-6" />,
      title: "Email",
      details: ["info@felicitystrategicadvisors.com"]
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <a
              ...
              className="bg-gradient-to-r from-[#004aad] to-[#ad0000] text-white p-6 rounded-xl text-center hover:from-[#003d8a] hover:to-[#8a0000] transition-all transform hover:scale-105 shadow-lg group"
            >
              <Calendar className="h-12 w-12 mx-auto mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-semibold mb-2">Book a Meeting</h3>
              <p className="text-white/90">Schedule a 30-minute consultation</p>
            </a>
            
            <a
              href="tel:+919560419070"
              className="bg-white dark:bg-gray-800 border-2 border-[#004aad] text-[#004aad] dark:text-blue-400 p-6 rounded-xl text-center hover:bg-[#004aad] hover:text-white dark:hover:bg-blue-400 dark:hover:text-white transition-all transform hover:scale-105 group"
            >
              ...
              <p className="opacity-80">+91 95604 19070</p>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white dark:bg-gray-800 border-2 border-[#0077b5] text-[#0077b5] p-6 rounded-xl text-center hover:bg-[#0077b5] hover:text-white transition-all transform hover:scale-105 group"
            >
              <Linkedin className="h-12 w-12 mx-auto mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-semibold mb-2">Connect on LinkedIn</h3>
              <p className="opacity-80">Follow our updates</p>
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors">
              We're here to help you navigate complex business challenges. Reach out to us through any of the channels below.
            </p>
          </div>
              ...
              <div key={index} className="text-center group">
                ...
                <div className="space-y-1">
                  {info.details.map((detail, detailIndex) => (
                    <p key={detailIndex} className="text-gray-600 dark:text-gray-400 transition-colors">
                      {detail}
                    </p>
                  ))}
                </div>
