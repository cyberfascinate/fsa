...
const Services = () => {
  const serviceCategories = [
    {
      id: 'taxation',
      image: '/images/services/Tax & Regulatory.jpg',
      title: 'Taxation & Regulatory Compliance',
      description:
        'Comprehensive tax solutions and regulatory compliance services to keep your business compliant and optimized.',
      services: [
    ...
    {
      id: 'corporate',
      image: '/images/services/Corporate & Startup.jpg',
      title: 'Corporate & Startup Services',
      description:
        'End-to-end corporate services from incorporation to governance, designed for startups and established businesses.',
      services: [
    ...
    {
      id: 'finance',
      image: '/images/services/Finance & Mgmt Advisory.jpg',
      title: 'Finance & Management Advisory',
      description:
        'Strategic financial guidance and management advisory services to optimize your business performance.',
      services: [
    ...
    },
    {
      ...
      description:
        'Cutting-edge AI and digital solutions to modernize your business operations and drive efficiency.',
      services: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl opacity-90 max-w-4xl mx-auto">
              Explore our full suite of consulting services, crafted to support
              startups, SMEs, and corporates with expert-backed solutions for
              sustainable growth.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors">
              From compliance to growth strategy, we provide integrated
              solutions that address every aspect of your business needs.
            </p>
          </div>
                      ...
                      <div className="absolute inset-0 p-8 flex flex-col justify-center text-white">
                        <div className="text-center">
                          ...
                          <p className="text-white/90 mb-6">
                            Our specialized team delivers tailored solutions
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors">
              Quick overview of our core service offerings
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {serviceCategories.map((category, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all group"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8 md:p-12 text-center transition-colors">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto transition-colors">
              Let our expert team help you navigate complex business challenges
              and unlock your growth potential. Contact us today for a
